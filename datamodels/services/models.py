...
class CarService(models.Model):
    ...
    car_service_type = models.PositiveSmallIntegerField(choices=ModelManager.CAR_SERVICE_TYPE_CHOICE,
                                                        ...
                                                        verbose_name='服务类型')
    customer = models.ForeignKey('customers.Customer', on_delete=models.CASCADE, verbose_name='发布人')
    ...
    place_pass = models.CharField(max_length=200, blank=True, verbose_name='途径地点')
    start_at = models.DateTimeField(verbose_name='出发时间')
    tel = models.CharField(max_length=20, verbose_name='联系方式')
    site_count = models.PositiveSmallIntegerField(default=0, verbose_name='座位个数')
